    ...
    <table class="tbl-qa">	
		<thead>
			 <tr>
                ...
                <th class="table-header" width="20%" colspan="2">Editar</th>
			  </tr>
		</thead>
		<tbody>		
			<?php
			...
			<tr class="table-row" id="row-<?php echo $row["id"]; ?>" >
                ...
                <td class="table-row" colspan="2"><a href="update_option.php?id=<?php echo $row["id"]; ?>" class="link"><img name="edit" id="edit" title="Edit" src="logo.ico"/></a></td>
			<?php
					}
				}
			?>
